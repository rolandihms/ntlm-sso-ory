export const ntlm_type_1_header = `NTLM TlRMTVNTUAABAAAAB7IIogcABwA1AAAADQANACgAAAAKADk4AAAAD0FQUC0xMC1QU1AtMDFOQU1QT1NU`;

export const ntlm_type_2_header = `NTLM TlRMTVNTUAACAAAAAAAAADgAAABVgphi4LSpuOdYihQAAAAAAAAAAKIAogA4AAAABQEoCgAAAA8CAA4AUgBFAFUAVABFAFIAUwABABwAVQBLAEIAUAAtAEMAQgBUAFIATQBGAEU
...
export const ntlm_type_3_header = `NTLM TlRMTVNTUAADAAAAGAAYAJAAAABEAUQBqAAAAA4ADgBYAAAAEAAQAGYAAAAaABoAdgAAAAAAAADsAQAABYKIIgoAOTgAAAAP62XBMuNVM4Foq1osnWwJak4AQQ
...
export const oauth_challenge_response = {
...
export const exchange_code_for_token_response = {
    access_token:
        "ory_at_7ZwN6FDVHvPufwRtvBQpY70fKJmju_RWffsdk2pjO80.rnJqR1GQanbgpQ4vxQ3Lq4nWsWS1BMQupI9I7MFEa-s",
    expires_in: 3600,
    scope: "",
    token_type: "bearer",
};
